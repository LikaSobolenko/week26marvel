...
const marvel = [
  ...
  },
  {
    ...
    img: "https://n1s1.hsmedia.ru/34/93/39/3493392c94fc2ae0552ef9c7e87f2617/1034x543_0xac120002_2692921231540468872.jpg",
  },
  {
    name: "Бэтмен",
    universe: "DC Comics",
      ...
      <div className="App">
        {marvel.map((marvel) => (
          <Marvel
            ...
            alterEgo={marvel.alterEgo}
            work={marvel.work}
            friends={marvel.friends}
            superPower={marvel.superPower}
            about={marvel.about}
          />
        ))}
      </div>
